...
first <- data.frame(date = firstFour$date, mean = toString(round(cases60$estimate, digits = 4)), confidence_interval = toString(round(cases60$conf.int, digits = 4)))
...
for (x in 1:10) {
 ...
 # print(toString(round(cases60$estimate, digits = 4)))
  #print(toString(round(cases60$conf.int, digits = 4)))
 # print(mean(filtered$cases_new))
  second <- data.frame(date = filtered$date, mean = toString(round(cases60$estimate, digits = 4)), confidence_interval = toString(round(cases60$conf.int, digits = 4)))
